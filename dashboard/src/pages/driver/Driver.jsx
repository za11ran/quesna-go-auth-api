                  ...
                  <div key={o.id} className="card card-pad">
                    ...
                    <p className="page-sub" style={{ margin: '6px 0' }}>
                      ...
                      {(o.address?.lat && o.address?.lng) ? (
                        ...
                        <> · <a href={`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(o.address_text)}`} target="_blank" rel="noreferrer">فتح في الخرائط</a></>
                      ) : null}
                    </p>
                    {o.notes && <p className="err" style={{ margin: '0 0 6px' }}>📝 ملحوظة العميل: {o.notes}</p>}
